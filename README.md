...
The Udacity code basis for the project can be find [here](https://github.com/udacity/CarND-Kidnapped-Vehicle-Project). Only `particle_filter.cpp`, `particle_filter.h` and `CMakeLists.txt` files have been modified. In addition, the files in data folder and `main_io.cpp` have been taken from the same repo 4829b0 in order to be able to run the program without the simulator.
